const html = `<html>
  ...
  <h1>LaFleet - Shape Upload</h1>
    ...
    <p>Copy/paste the shape into the form below and press "Submit" button to upload to finally save in the backend.</p>
    
    <form action="/upload-shape" method="post">
      <textarea id="shapeJson" name="shapeJson" rows="20" cols="100" style="resize: true, monospace: true"></textarea> <br /><br />
